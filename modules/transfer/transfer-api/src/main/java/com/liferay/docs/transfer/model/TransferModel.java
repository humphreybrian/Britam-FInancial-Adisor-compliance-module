...
/**
 * The base model interface for the Transfer service. Represents a row in the &quot;GB_Transfer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.docs.transfer.model.impl.TransferModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.docs.transfer.model.impl.TransferImpl</code>.
 * </p>
 *
 * @author liferay
 * @see Transfer
...
public interface TransferModel
	extends BaseModel<Transfer>, GroupedModel, ShardedModel, StagedAuditedModel,
			WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a transfer model instance should use the {@link Transfer} interface instead.
	 */
