...
public class EntryUtil {
	...
	public static Entry findByUuid_First(
		...
		throws com.liferay.docs.transfer.exception.NoSuchEntryException {
	 ...
	 * @return the matching entries
	 */
	public static List<Entry> findByG_G(long groupId, long transferId) {
		return getPersistence().findByG_G(groupId, transferId);
	}
	...
	public static List<Entry> findByG_G(
		...
		return getPersistence().findByG_G(groupId, transferId, start, end);
	}
	...
	public static List<Entry> findByG_G(
		...
		return getPersistence().findByG_G(
			groupId, transferId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static Entry findByG_G_First(
		...
		return getPersistence().findByG_G_First(
			groupId, transferId, orderByComparator);
	}
	...
	public static Entry[] findByG_G_PrevAndNext(
		...
		return getPersistence().findByG_G_PrevAndNext(
			entryId, groupId, transferId, orderByComparator);
	}
	 ...
	 * @param transferId the transfer ID
	 */
	public static void removeByG_G(long groupId, long transferId) {
		getPersistence().removeByG_G(groupId, transferId);
	}
	 ...
	 * @return the number of matching entries
	 */
	public static int countByG_G(long groupId, long transferId) {
		return getPersistence().countByG_G(groupId, transferId);
	}
