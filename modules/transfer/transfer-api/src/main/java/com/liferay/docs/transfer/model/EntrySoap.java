...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.docs.transfer.service.http.EntryServiceSoap}.
 *
 * @author liferay
 * @generated
 */
...
public class EntrySoap implements Serializable {
	...
	public static EntrySoap toSoapModel(Entry model) {
		...
		soapModel.setContract(model.getContract());
		soapModel.setUnit(model.getUnit());
		soapModel.setBranch(model.getBranch());
		soapModel.setUnit2(model.getUnit2());
		soapModel.setBranch2(model.getBranch2());
