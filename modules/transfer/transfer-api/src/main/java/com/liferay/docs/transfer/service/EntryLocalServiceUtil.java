 ...
 * <code>com.liferay.docs.transfer.service.impl.EntryLocalServiceImpl</code> and
...
public class EntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.transfer.service.impl.EntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.docs.transfer.model.Entry addEntry(
		com.liferay.docs.transfer.model.Entry entry) {

		return getService().addEntry(entry);
	}

	public static com.liferay.docs.transfer.model.Entry addEntry(
			long userId, long transferId, String name, String email,
			String message, String type, String category, String contract,
			String unit, String branch, String unit2, String branch2,
			String comments,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addEntry(
			userId, transferId, name, email, message, type, category, contract,
			unit, branch, unit2, branch2, comments, serviceContext);
	}
	 ...
	 */
	public static com.liferay.docs.transfer.model.Entry createEntry(
		long entryId) {
	 ...
	 */
	public static com.liferay.docs.transfer.model.Entry deleteEntry(
		com.liferay.docs.transfer.model.Entry entry) {
	...
	public static com.liferay.docs.transfer.model.Entry fetchEntry(
		long entryId) {
	 ...
	 */
	public static com.liferay.docs.transfer.model.Entry
	 ...
	 */
	public static java.util.List<com.liferay.docs.transfer.model.Entry>
	...
	public static java.util.List<com.liferay.docs.transfer.model.Entry>
		getEntries(long groupId, long transferId) {

		return getService().getEntries(groupId, transferId);
	}

	public static java.util.List<com.liferay.docs.transfer.model.Entry>
			getEntries(long groupId, long transferId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {

		return getService().getEntries(groupId, transferId, start, end);
	}
	...
	public static java.util.List<com.liferay.docs.transfer.model.Entry>
		getEntries(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<com.liferay.docs.transfer.model.Entry> obc) {

		return getService().getEntries(groupId, transferId, start, end, obc);
	}
	...
	public static java.util.List<com.liferay.docs.transfer.model.Entry>
		getEntriesByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<com.liferay.docs.transfer.model.Entry> orderByComparator) {
	...
	public static int getEntriesCount(long groupId, long transferId) {
		return getService().getEntriesCount(groupId, transferId);
	}
	 ...
	 * @throws PortalException if a entry with the primary key could not be found
	 */
	public static com.liferay.docs.transfer.model.Entry getEntry(long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static com.liferay.docs.transfer.model.Entry updateEntry(
		com.liferay.docs.transfer.model.Entry entry) {
	...
	public static com.liferay.docs.transfer.model.Entry updateEntry(
			long userId, long transferId, long entryId, String name,
			String email, String message, String type, String category,
			String contract, String unit, String branch, String unit2,
			String branch2, String comments,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
			   com.liferay.portal.kernel.exception.SystemException {

		return getService().updateEntry(
			userId, transferId, entryId, name, email, message, type, category,
			contract, unit, branch, unit2, branch2, comments, serviceContext);
	}
