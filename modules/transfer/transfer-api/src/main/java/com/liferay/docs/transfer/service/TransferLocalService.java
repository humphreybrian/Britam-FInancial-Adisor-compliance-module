...
/**
 * Provides the local service interface for Transfer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see TransferLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TransferLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TransferLocalServiceUtil} to access the transfer local service. Add custom service methods to <code>com.liferay.docs.transfer.service.impl.TransferLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Transfer deleteTransfer(
			long transferId, ServiceContext serviceContext)
	...
	public List<Transfer> getTransfers(
		long groupId, int start, int end, OrderByComparator<Transfer> obc);
